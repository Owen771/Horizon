...
const AuthForm = ({ type }: { type: string }) => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    // The form fields, that reached here, are always type-safe and validated, powered by zod and ts
    setisLoading(true);
    try {
        ...
        <>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              {/* Email and password are shared by sign-in and sign-up page */}
              <CustomInput
                control={form.control}
                name="email"
                label="Email"
